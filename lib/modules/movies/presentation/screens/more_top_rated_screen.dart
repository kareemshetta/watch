...
class TopRatedMoreScreen extends StatefulWidget {
  const TopRatedMoreScreen({Key? key}) : super(key: key);

  @override
  State<TopRatedMoreScreen> createState() => _TopRatedMoreScreenState();
}

class _TopRatedMoreScreenState extends State<TopRatedMoreScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MoviesBloc, MoviesState>(
      builder: (context, state) {
        final movieList = BlocProvider.of<MoviesBloc>(context).topRatedMovies;
        return Scaffold(
            appBar: AppBar(
                title: Text(
              'TopRated',
                                ...
                                InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    child: CachedNetworkImage(
                                      imageUrl:
                                          concatImagePath(movie.backdropPath!),
